...
public sealed class UpdateSchoolInterviewAssessmentPolicyCommandValidator
    : AbstractValidator<UpdateSchoolInterviewAssessmentPolicyCommand>
{
    public UpdateSchoolInterviewAssessmentPolicyCommandValidator()
    {
