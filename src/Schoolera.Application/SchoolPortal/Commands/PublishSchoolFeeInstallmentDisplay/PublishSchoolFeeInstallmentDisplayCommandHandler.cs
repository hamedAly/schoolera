...
public sealed record PublishSchoolFeeInstallmentDisplayCommand(
    Guid SchoolId,
    Guid FeeId,
    Guid ItemId) : IRequest<Result<SchoolFeeInstallmentDisplayDto>>;

public sealed class PublishSchoolFeeInstallmentDisplayCommandHandler(
    ISchoolPortalAccess portalAccess,
    ISchoolPortalRepository repository,
    IUnitOfWork unitOfWork,
    IStringLocalizer<SchoolPortalMessages> localizer,
    ILogger<PublishSchoolFeeInstallmentDisplayCommandHandler> logger)
    : IRequestHandler<PublishSchoolFeeInstallmentDisplayCommand, Result<SchoolFeeInstallmentDisplayDto>>
{
    public async Task<Result<SchoolFeeInstallmentDisplayDto>> Handle(
        PublishSchoolFeeInstallmentDisplayCommand request,
