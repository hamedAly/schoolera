...
public sealed record PublishSchoolPublishedDiscountCommand(
    Guid SchoolId,
    Guid ItemId) : IRequest<Result<SchoolPublishedDiscountDto>>;

public sealed class PublishSchoolPublishedDiscountCommandHandler(
    ISchoolPortalAccess portalAccess,
    ISchoolPortalRepository repository,
    IUnitOfWork unitOfWork,
    IStringLocalizer<SchoolPortalMessages> localizer,
    ILogger<PublishSchoolPublishedDiscountCommandHandler> logger)
    : IRequestHandler<PublishSchoolPublishedDiscountCommand, Result<SchoolPublishedDiscountDto>>
{
    public async Task<Result<SchoolPublishedDiscountDto>> Handle(
        PublishSchoolPublishedDiscountCommand request,
