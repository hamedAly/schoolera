...
public sealed class CreateSchoolChildAgeEligibilityRuleCommandValidator
    : AbstractValidator<CreateSchoolChildAgeEligibilityRuleCommand>
{
    public CreateSchoolChildAgeEligibilityRuleCommandValidator()
    {
