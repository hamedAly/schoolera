...
public sealed record DeactivateSchoolAdditionalServiceCommand(Guid SchoolId, Guid ServiceId)

    : IRequest<Result<SchoolAdditionalServiceDto>>;



public sealed class DeactivateSchoolAdditionalServiceCommandHandler(
    ...
    ILogger<DeactivateSchoolAdditionalServiceCommandHandler> logger)
    : IRequestHandler<DeactivateSchoolAdditionalServiceCommand, Result<SchoolAdditionalServiceDto>>

{

    public async Task<Result<SchoolAdditionalServiceDto>> Handle(

        DeactivateSchoolAdditionalServiceCommand request,
