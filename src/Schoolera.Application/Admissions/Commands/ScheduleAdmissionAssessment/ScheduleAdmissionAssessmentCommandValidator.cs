...
public sealed class ScheduleAdmissionAssessmentCommandValidator
    : AbstractValidator<ScheduleAdmissionAssessmentCommand>
{
    public ScheduleAdmissionAssessmentCommandValidator()
    {
