...
public sealed class MarkAdmissionRegisteredCommandValidator
    : AbstractValidator<MarkAdmissionRegisteredCommand>
{
    public MarkAdmissionRegisteredCommandValidator()
    {
