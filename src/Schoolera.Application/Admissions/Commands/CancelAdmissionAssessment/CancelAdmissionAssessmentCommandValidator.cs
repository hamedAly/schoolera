...
public sealed class CancelAdmissionAssessmentCommandValidator
    : AbstractValidator<CancelAdmissionAssessmentCommand>
{
    public CancelAdmissionAssessmentCommandValidator()
    {
