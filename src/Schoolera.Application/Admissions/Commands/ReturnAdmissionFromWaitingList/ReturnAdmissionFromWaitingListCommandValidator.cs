...
public sealed class ReturnAdmissionFromWaitingListCommandValidator
    : AbstractValidator<ReturnAdmissionFromWaitingListCommand>
{
    public ReturnAdmissionFromWaitingListCommandValidator()
    {
