...
public sealed class RequestMissingDocumentsCommandValidator
    : AbstractValidator<RequestMissingDocumentsCommand>
{
    public RequestMissingDocumentsCommandValidator()
    {
