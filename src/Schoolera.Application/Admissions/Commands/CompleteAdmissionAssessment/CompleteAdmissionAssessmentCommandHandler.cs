...
public sealed record CompleteAdmissionAssessmentCommand(
...
public sealed class CompleteAdmissionAssessmentCommandHandler(
    ...
    ILogger<CompleteAdmissionAssessmentCommandHandler> logger,
    IStringLocalizer<SchoolPortalMessages> localizer)
    : IRequestHandler<CompleteAdmissionAssessmentCommand, Result<SchoolAdmissionApplicationDetailDto>>
{
    public async Task<Result<SchoolAdmissionApplicationDetailDto>> Handle(
        CompleteAdmissionAssessmentCommand request,
        CancellationToken cancellationToken)
    {
        ...
        return AdmissionResults.Failure<SchoolAdmissionApplicationDetailDto>(
            "The assessment must be completed by finalizing its evaluation result.",
