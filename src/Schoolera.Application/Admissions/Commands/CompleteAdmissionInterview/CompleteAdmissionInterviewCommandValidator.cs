...
public sealed class CompleteAdmissionInterviewCommandValidator
    : AbstractValidator<CompleteAdmissionInterviewCommand>
{
    public CompleteAdmissionInterviewCommandValidator()
    {
