...
public sealed class ListAdminAdmissionApplicationsQueryValidator
    : AbstractValidator<ListAdminAdmissionApplicationsQuery>
{
    ...
    public ListAdminAdmissionApplicationsQueryValidator()
    {
