...
public sealed class UpdateEducationalStageCommandValidator : AbstractValidator<UpdateEducationalStageCommand>
{
    public UpdateEducationalStageCommandValidator(IStringLocalizer<ValidationMessages> localizer)
    {
