...
@Component({
  selector: 'se-register-school-owner-page',
  imports: [
    AutofocusDirective,
    Breadcrumbs,
    Button,
  ...
  templateUrl: './register-school-owner-page.html',
  styleUrl: './register-school-owner-page.scss',
})
export class RegisterSchoolOwnerPage {
